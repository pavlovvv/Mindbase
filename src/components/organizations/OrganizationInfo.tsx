    ...
    <section className={styles.main__info}>
      <div className={styles["main__info-left-wrapper"]}>
        ...
        <div className={styles.info__item}>
          <h2 className={styles.info__heading}>Tags</h2>
        ...
        <div className={styles.info__item}>
          <h2 className={styles.info__heading}>Sale Channels</h2>
      ...
      <div style={{ flex: 1 }} className={styles["main__info-right-wrapper"]}>
        <div
          className={styles.info__item + " " + styles.info__item_right}
        ...
        >
          ...
          <div
            style={{ display: "flex", columnGap: "220px", flexWrap: "wrap" }}
          >
            <div className={styles["info__main-object"]}>
              ...
              <div>
                <div className={styles["info__main-object-inner"]}>
                  <div
                    className={
                      styles["info__regular-text"] +
                      " " +
                      styles["info__regular-text_underline"]
                    }
            ...
            <div
              className={
                styles["info__main-object"] +
                " " +
                styles["info__main-object_social-media"]
              }
            >
              <div
                className={
                  styles["info__main-object-inner"] +
                  " " +
                  styles["info__main-object-inner_socail-media"]
                }
              >
                <img src={inst} className={styles["info__contacts-img"]} />
                <a
                  href="https://instagram.com/innovation_hills/"
                  target="_blank"
                  className={
                    styles["info__regular-text"] +
                    " " +
              ...
              >
                ...
                <a
                  href="https://x.com/innovation_hills/"
                  target="_blank"
                  className={
                    styles["info__regular-text"] +
                    " " +
              ...
              >
                ...
                <a
                  href="https://linkedin.com/innovation_hills/"
                  target="_blank"
                  className={
                    styles["info__regular-text"] +
                    " " +
        ...
        <div className={styles.info__item + " " + styles.info__item_right}>
          <h2 className={styles.info__heading}>Offices</h2>

          <div className={styles["info__main-object"]}>
            <div>
              2, Street address, Details
              <div>
                <span className={styles["info__left-text_heading"]}>
                  Tokyo, Japan, 88888
                </span>{" "}
                <span className={styles["info__regular-text_grey"]}>
                  {" "}
                  - 8:01 pm local time
                </span>
              </div>
        ...
        <div
          className={
            styles.info__item +
            " " +
            styles.info__item_right +
            " " +
            styles.info__item_about
          }
        >
          <h2 className={styles.info__heading}>About</h2>

          <div
            className={styles["info__main-object"]}
          ...
          >
            ...
            each field can gather. The first project to build an ecosystem that
            implements our ideal social model is "Innovation Hills," which will
            be built on a 60,000 m2 plateau left by a former urban plan.
          </div>

          <div
            className={
              styles["info__main-object"] + " " + styles["react-player"]
            }
          >
            <ReactPlayer
