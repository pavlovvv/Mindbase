...
export default function DesktopOrganizations() {
    ...
    return (<>
        <section className={styles['main-organizations']}>
            <img src={orgLogoDesktop} alt="user-photo" style={{ minWidth: '285px', borderRadius: '8px', zIndex: 2, alignSelf: 'flex-start' }} />
            <div className={styles.main__left_org}>
                <div className={styles['main__left-top_org']}>
                    <div className={styles['main__left-top-heading']}>Innovation Hills</div>
                ...
                <div className={styles['main-button'] + ' ' + styles['card__view-more']} style={{ marginTop: '14px' }}>View more</div>
            </div>
