...
export default function DiscoverSwiper() {
    ...
    useEffect(() => {
        ...
        const handleMouseEnter = () => {
            if (swiperElement) {
                const prevButton = swiperElement.querySelector('.swiper-button-prev') as HTMLElement;
                const nextButton = swiperElement.querySelector('.swiper-button-next') as HTMLElement;
    ...
    return (
        <div ref={swiperRef} className={styles['needspage__product-images']}>
            <Swiper loop navigation={true} modules={[Navigation]} className={styles.swiper}>
                <SwiperSlide><img src={tent1} alt="tent" /></SwiperSlide>
                <SwiperSlide><img src={emptyFrame} alt="tent" /></SwiperSlide>
                <SwiperSlide><img src={emptyFrame} alt="tent" /></SwiperSlide>
                <SwiperSlide><img src={tent4} alt="tent" /></SwiperSlide>
            </Swiper>
