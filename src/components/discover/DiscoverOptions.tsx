    ...
    <div className={type === 'needs' ? styles['wrapper_bg-blue'] : styles.wrapper}>
      ...
      <div className={styles.discover__cards}>
        <div className={styles.card_services}>
          ...
          {!isMobile ?
            <Link to={`/${type}/services`}> <Shimmer> <img src={servicesCard} alt="service-card" />       </Shimmer> </Link>
            :
        ...
        <div className={styles.card_partnership}>
          ...
          {!isMobile ?
            <Link to={`/${type}/partnership`}> <Shimmer> <img src={partnershipCard} alt="partnership-card" /> </Shimmer> </Link>
            :
        ...
        <div className={styles.card_products}>
          ...
          {!isMobile ?
            <Link to={`/${type}/product`}> <Shimmer> <img src={productCard} alt="product-card" /> </Shimmer> </Link>
            :
