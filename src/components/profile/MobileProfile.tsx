...
export default function MobileProfile() {
  ...
  const { getCollapseProps, getToggleProps } = useCollapse({ isExpanded, collapsedHeight: 288 })

  return (<>
    <section className={mainStyles.main}>
      <div className={mainStyles.main__top_mobile}>
        <div style={{ position: 'relative', width: '20vw', minWidth: '80px' }}>
          <img src={PhotoFull} alt="user-photo" style={{ width: '100%', borderRadius: '50%' }} />
        ...
        <div>
          <div className={mainStyles['right-top']}>
            ...
            <div className={mainStyles.share}>Share <img src={shareIcon} /></div>
          </div>

          <div className={mainStyles['right-bottom']}> <img src={locationIcon} /> Tokyo, Japan - 8:01 pm local time </div>
        </div>
      </div>
